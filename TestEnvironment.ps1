...
Set-AzVMExtension -ResourceGroupName "MyResourceGroup" -ExtensionName "IIS" -VMName "myVM" -Location "EastUS" -Publisher Microsoft.Compute -ExtensionType CustomScriptExtension -TypeHandlerVersion 1.8 -SettingString '{"commandToExecute":"powershell Add-WindowsFeature Web-Server; powershell Add-Content -Path \"C:\\inetpub\\wwwroot\\Default.htm\" -Value $($env:computername)"}'

Get-AzPublicIPAddress -ResourceGroupName "MyResourceGroup" -Name "PublicIPVM1" | select IpAddress 
